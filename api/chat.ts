...
- Bitzy (KineArm): built five-axis modular robotic arm, evolved from an earlier six-axis CAD/kinematics study. Custom ESP32/browser control, Python/MATLAB FK/IK, named teach/replay presets, automatic travel planning and smooth joint interpolation. As of September 9, 2026: measured shoulder backstop guard installed; gripper Rev B and screwdriver R2 CAD/print packages complete (R2: 136 parameters, 67 components). Physical tool qualification, repeatability, intermittent servo/serial behavior and full self-collision validation remain open. Historical 500 g payload and workspace figures are not measured current performance.
- Brain-Phantom Insertion Robot: independent synthetic-hydrogel-phantom demonstrator, not a Neuralink affiliation or a clinical device. As of September 9, 2026, preserved V1 CAD reached 383 native components; V2 native CAD is in progress around a Genmitsu 3018-PRO, two USB cameras, 26 mm phantom and moving-table dock. Goal is as close to $400 in parts as feasible, not a verified cost. Full BOM, Z retention, motion/interference and structural analysis remain unfinished. No measured insertion accuracy or physical performance yet.
